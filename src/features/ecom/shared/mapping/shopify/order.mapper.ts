...
export function mapShopifyOrder(o: any, cInfo: any): OrderDto {
	...
	// ORDER INFO
	if (o.totalPrice?.currencyCode !== undefined) mo.currencyCode = o.totalPrice.currencyCode;
	...
	if (o.fulfillmentStatus !== undefined) mo.completed = o.fulfillmentStatus === 'FULFILLED';
	...
	if (cInfo.defaultAddress?.zip !== undefined) mo.customerZip = cInfo.defaultAddress.zip;
	if (cInfo.defaultAddress?.city !== undefined) mo.customerCity = cInfo.defaultAddress.city;
	...
	if (o.shippingAddress?.name !== undefined) mo.deliveryName = o.shippingAddress.name;
	...
	if (o.shippingAddress?.zip !== undefined) mo.deliveryZip = o.shippingAddress.zip;
	...
	if (o.shippingAddress?.city !== undefined) mo.deliveryCity = o.shippingAddress.city;
	if (o.shippingAddress?.phone !== undefined) mo.deliveryPhone = o.shippingAddress.phone;

	// PRICING
	if (o.currentTotalPrice !== undefined) mo.price = mapShopifyPrice(o.currentTotalPrice);
