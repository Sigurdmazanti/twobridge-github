...
export function mapDynamicwebOrder(o: any): OrderDto {
	...
	if (o.customerFirstName !== undefined) mo.customerFirstName = o.customerFirstName;
	...
	if (o.customerAddress2 !== undefined) mo.customerAddress2 = o.customerAddress2;
	...
	if (o.customerCountryCode !== undefined) mo.customerCountryCode = o.customerCountryCode;
	...
	if (o.deliveryFirstName !== undefined) mo.deliveryFirstName = o.deliveryFirstName;
	...
	if (o.deliveryAddress2 !== undefined) mo.deliveryAddress2 = o.deliveryAddress2;
	...
	if (o.deliveryCountryCode !== undefined) mo.deliveryCountryCode = o.deliveryCountryCode;
	...
	if (o.shippingFee !== undefined) mo.shippingFee = mapDynamicwebPrice(o.shippingFee);
