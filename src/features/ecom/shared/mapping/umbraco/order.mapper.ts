...
export function mapUmbracoOrder(o: any): OrderDto {
    ...
    if(o.paymentInfo?.country?.code) mo.countryCode = o.paymentInfo.country.code;
    ...
    if(o.customerInfo?.customerReference) mo.customerUserId = o.customerInfo.customerReference;
    ...
    if(o.properties?.firstName && o.properties?.lastName) mo.customerName = `${o.properties.firstName} ${o.properties.lastName}`
    ...
    if(o.properties?.billingAddressLine1) mo.customerAddress = o.properties.billingAddressLine1;
    if(o.properties?.billingAddressLine2) mo.customerAddress2 = o.properties.billingAddressLine2;
    if(o.properties?.billingZipCode) mo.customerZip = o.properties.billingZipCode;
    ...
    if(o.shippingInfo?.country?.code) mo.customerCountryCode = o.shippingInfo.country.code;
    ...
    if(o.properties?.shippingFirstName && o.properties?.shippingLastName) mo.deliveryName = `${o.properties.shippingFirstName} ${o.properties.shippingLastName}`
    if(o.properties?.shippingFirstName) mo.deliveryFirstName = o.properties.shippingFirstName;
    if(o.properties?.shippingLastName) mo.deliverySurname = o.properties.shippingLastName;
    ...
    if(o.properties?.shippingAddressLine1) mo.deliveryAddress = o.properties.shippingAddressLine1;
    if(o.properties?.shippingAddressLine2) mo.deliveryAddress2 = o.properties.shippingAddressLine2;
    if(o.properties?.shippingZipCode) mo.deliveryZip = o.properties.shippingZipCode;
    if(o.properties?.shippingCity) mo.deliveryCity = o.properties.shippingCity;
    if(o.shippingInfo?.country?.name) mo.deliveryCountry = o.shippingInfo.country.name;
    if(o.shippingInfo?.country?.code) mo.deliveryCountryCode = o.shippingInfo.country.code;
	...
	if(o.transactionInfo?.authorizedAmount) mo.price = mapUmbracoPrice(o.transactionInfo.authorizedAmount)
    if(o.subtotalPrice) mo.totalPriceWithoutDiscountsFeesAndTaxes = mapUmbracoPrice(o.subtotalPrice)
    if(o.totalPrice) mo.priceBeforeFees = mapUmbracoPrice(o.totalPrice)
    if(o.shippingInfo?.totalPrice?.value?.withTax !== null) mo.shippingFee = o.shippingInfo.totalPrice.value.withTax;
    if(o.shippingInfo) mo.shippingMethod = mapUmbracoShippingMethod(o.shippingInfo)
	if(o.paymentInfo) mo.paymentMethod = mapUmbracoPaymentMethod(o.paymentInfo)
    if(o.transactionInfo?.feeAmount?.value !== null) mo.paymentFee = o.transactionInfo.feeAmount.value;
